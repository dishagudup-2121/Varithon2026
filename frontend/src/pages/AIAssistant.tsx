...
const suggestedQuestions = [
  "assistant.suggestions.highRisk",
  "assistant.suggestions.ambulanceEta",
  "assistant.suggestions.routeRisk",
  "assistant.suggestions.runSimulation"
];
...
export default function AIAssistant() {
  ...
  const sendQuestion = (responseKey: string) => {
    setMessages((previous) => [
      ...
      },
      {
        ...
        role: "assistant",
        text: "assistant.responses.offline",
        isTranslationKey: true,
      },
    ]);
  };
            ...
            {messages.length === 0 ? (
              ...
              <div className="flex min-h-[300px] sm:min-h-[350px] flex-col items-center justify-center text-center px-2">
                ...
                <div className="mt-5 sm:mt-6 grid w-full max-w-2xl grid-cols-1 gap-2.5 sm:gap-3 md:grid-cols-2">
                  ...
                  {suggestedQuestions.map((suggestion: string, index: number) => (
                      <SuggestionButton
                        key={index}
